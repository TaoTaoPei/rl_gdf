...
private:
    ...
    rclcpp::Publisher<robot_msgs::msg::RobotCommand>::SharedPtr robot_command_publisher; // 电机指令发布
    rclcpp::Subscription<robot_msgs::msg::RobotState>::SharedPtr robot_state_subscriber; // 电机反馈订阅
    ...
    std::vector<int64_t> new_order = {3, 4, 5, 0, 1, 2, 9, 10, 11, 6, 7, 8};
